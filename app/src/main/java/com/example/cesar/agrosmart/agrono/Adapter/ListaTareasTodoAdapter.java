...
public class ListaTareasTodoAdapter extends RecyclerView.Adapter<ListaTareasTodoAdapter.ViewHolder> {
    ...
    public ListaTareasTodoAdapter(Context context, String jwt, String ubicacion) {
    ...
    @NonNull
    @Override
    public ListaTareasTodoAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.agronomo_item_tarea_todo, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ListaTareasTodoAdapter.ViewHolder holder, int position) {
