...
import com.example.cesar.agrosmart.agrono.Adapter.ListaTareaDontAdapter;
...
public class agronomoTareaDont extends Fragment {

    private static final String TAG="dont";

    private String jwt, idparcela, ubicacion, estado;
    private Retrofit retrofit;
    private ListaTareaDontAdapter listaTareaDontAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.agronomo_fragment_tarea_dont, container, false);
    }
    ...
    public void onViewCreated(@NonNull final View view, @Nullable Bundle savedInstanceState) {
        ...
        listaTareaDontAdapter =new ListaTareaDontAdapter(getContext(),jwt,ubicacion);
        recyclerView.setAdapter(listaTareaDontAdapter);
        ...
        listaTareaDontAdapter.registerAdapterDataObserver(new RecyclerView.AdapterDataObserver() {
            @Override
            ...
            try {
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        listaTareaDontAdapter.updateData(id,tarea,inicio,fin);
            ...
            try {
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        listaTareaDontAdapter.removeDataSocket(id);
                    }
                });
            }catch (RuntimeException e){
                Log.d("runtime", "problema OnCreate");
                ...
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(!estado.equals("0")) {
                            ...
                            listaTareaDontAdapter.addTarea(new tareas(id, tarea,inicio,fin,estado));
                        }
                    }
                });
            }catch (RuntimeException e){
    ...
    private void setScrollbar(){
        recyclerView.scrollToPosition(listaTareaDontAdapter.getItemCount()-1);
    }


    private void deleteTarea(final int position){
        String id= listaTareaDontAdapter.getID(position);
        ...
        respuestaCall.enqueue(new Callback<Respuesta>() {
            ...
            public void onResponse(Call<Respuesta> call, Response<Respuesta> response) {
                ...
                listaTareaDontAdapter.removeData(position);
            }
    ...
    private void obtenerdatos(){
        ...
        readTareasRespuestaCall.enqueue(new Callback<ReadTareasRespuesta>() {
            ...
            public void onResponse(Call<ReadTareasRespuesta> call, Response<ReadTareasRespuesta> response) {
                ...
                listaTareaDontAdapter.adicionarListaTareas(listaTareas);
            }
