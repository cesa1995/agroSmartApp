...
public class ListaTareaDontAdapter extends RecyclerView.Adapter<ListaTareaDontAdapter.ViewHolder>{
    private ArrayList<tareas> dataset;
    private ArrayList<tareas> datasetFiltered;
    private Context context;
    private String jwt, ubicacion;

    public ListaTareaDontAdapter(Context context, String jwt, String ubicacion) {
    ...
    @NonNull
    @Override
    public ListaTareaDontAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.agronomo_item_tarea_dont, parent, false);
        return new ListaTareaDontAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ListaTareaDontAdapter.ViewHolder holder, int position) {
