...
public class ListaEquipoAdminAdapter extends RecyclerView.Adapter<ListaEquipoAdminAdapter.ViewHolder>{
    ...
    public ListaEquipoAdminAdapter(Context context, String jwt){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.admin_item_admin_equipos,parent,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        private void borrarEquipos(){
            ...
            Call<Respuesta> respuestaCall = service.eliminarEquipo(new idANDjwtBody(id,jwt));
