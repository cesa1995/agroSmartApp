...
public class addParcelas extends Fragment {

    public static final String TAG = "addparcela";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.admin_fragment_add_parcelas, container, false);
    }
    ...
    private void guardarParcela(){
        ...
        if (cancel){
            ...
            Call<Respuesta> respuestaCall = service.guardarParcela(new addParcelaBody(nombre, tipo,jwt));
